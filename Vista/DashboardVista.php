                ...
                <div style="width:100%">
                  <nav>
                     <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                      ...
                      <?php if(in_array("M24",$modulosAcceso)){ ?><a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false" onclick="mostrar(1);">OPERACIÓN</a><?php }?>  
				  ...
				  <!-- <div class="row" style="width:60%; margin: 15px auto;">	
				   ...
				   <div id="invoice">
                    ...
                    <tbody id="contenflota">
						   ...
						   <iframe title="DASHBOARD TIEMPOS Y SERVICIOS" width="100%" height="800px" 
						   src="https://app.powerbi.com/view?r=eyJrIjoiZTZiMzQ3NGMtYjk4OS00ZmJlLTlkNTEtYzMwZGE0OGFhMjVlIiwidCI6IjYwMjkyY2RlLTIxYTQtNDQ1NS04ZjlmLTY1NTQ0YzI4NzMzMSJ9" frameborder="0" allowFullScreen="true"></iframe>
