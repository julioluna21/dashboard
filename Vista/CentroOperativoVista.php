...
?>
 <div id="page-content-wrapper" style="">
		...
		<div class=" shadow p-3  mb-5 bg-white rounded">
		 ...
		 <div class="x_title  ">
            <h1>Centro Operativo <small>Registro</small></h1>
            ...
            <form name="formregistros" id="formregistros" method="POST">
                            <div class="row">
                              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Nombre Centro  Operativo:</label>
                            ...
                            <div class="row">
							    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Tipo Centro Operativo:</label>
...
<script type="text/javascript" src="../Ajax/CentroAjaxa.js"></script>
