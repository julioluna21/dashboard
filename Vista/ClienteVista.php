...
?>
 <div id="page-content-wrapper" style="">
		...
		<div class=" shadow p-3  mb-5 bg-white rounded">
		 ...
		 <div class="x_title  ">
            <h1>Cliente <small> Registro</small></h1>
            ...
            <form name="formregistros" id="formregistros" method="POST">
                            <div class="row">
							   ...
							   <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control" name="nit" id="nit" onkeypress="Numero(event)"  required="" autofocus>
                              </div>	
                              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                             ...
                             <div class="row">
                              ...
                              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control" name="administrador" id="administrador" min="0"  required="" autofocus>
                              </div>
                             
                            </div>
				
				            <div class="row" >
                    <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12" id="mdacceso">
                              <label>Socios:</label><br>
                              <label>Regency sas:</label>
                    <SPAN title="regency" style="float:right">
                        <input type="checkbox" class="" name="permiso[]" id="r1" value="1"  /></SPAN><br>
                        
                         <label>RQS:</label>
                         <SPAN title="rqs" style="float:right">
                             <input type="checkbox" class="" name="permiso[]" id="r2" style=""  value="2"  /></SPAN><br>
                        <label>Regency Tech:</label>
                           <SPAN title="regency tech" style="float:right">
                               <input type="checkbox" class="" name="permiso[]" id="r3"   value="3"  /> </SPAN><br>
                            <label>Regency Health:</label>
                           <SPAN title="regency tech" style="float:right">
                            <input type="checkbox" class="" name="permiso[]" id="r4"   value="4"  /> </SPAN><br>     
                           <label>Protinco LTDA:</label>
                           <SPAN title="protinco ltda" style="float:right">
                            <input type="checkbox" class="" name="permiso[]" id="r5"   value="5"  /> </SPAN><br>         
                            </div>  
...
<script type="text/javascript" src="../Ajax/ClienteAjax.js"></script>
