            ...
            <form name="formregistros" id="formregistros" method="POST">
                            <div class="row">
				             ...
				             <div class="row">
							   <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>No OS:</label>
								<input type="text" class="form-control" name="nos" id="nos" readonly>
                              </div> 
							  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Tarifa:</label>
...
<!--ejecuta cancelar formulario-->
				    ...
				    <form name="formotrosi" id="formotrosi" method="POST">
                            <div class="row">
							    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								 <input type="hidden"  name="Idcontrato" id="Idcontrato2">	
                                <label>Objeto OS:</label>
								<textarea class="form-control" name="objeto" id="objeto2" required></textarea>	
