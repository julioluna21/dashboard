...
.search-item svg {
 ...
 <div id="page-content-wrapper" style="">
          ...
          <div class="x_content">
            ...
            <div class="modal fade" id="modal-reporte" tabindex="-1" role="dialog" aria-labelledby="modal-reporte-label" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">

             <form name="formreporte" id="formreporte" method="POST">  

                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modal-preguntas-label">REPORTE REGISTRO ASISTENCIAL</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="limpiarReporte()">
				             ...
				             <div class="form-group col-lg-6 col-md-6 col-sm-3 col-xs-12">
                                ...
                                <input type="date" class="form-control" name="fechainicalR" id="fechainicalR" required >
                              </div>
				  
				             <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Fecha Final:</label>
                                <input type="date" class="form-control" name="fechafinalR" id="fechafinalR" required >
                              </div>
                            ...
                            <select class="form-control"  id="ReporteCentro" >
								            </select>	
                            </div>
                            <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12" >
                             <SPAN title="Agregar tabla">
                                <button class="btn" type="button" style="background: #871F1B; color:white; margin-top:33px" onclick="agregartablaR();" ><i class="fa fa-plus-circle"></i>
                                </button>
                              </SPAN>       
                            </div>
    ...
    <div class="invoice overflow-auto">
              <table border="0" cellspacing="0" cellpadding="0" id="tblreporte" style="width:100%;">
              <thead>
              <tr>
                  ...
                  <tbody>
                                                        ...
                                                        <div class="modal-footer">
                                                          <SPAN title="Generar Reporte">
                                <button class="btn btn-secondary" type="submit" id=""><i class="fa fa-file-excel-o"></i> Generar
                                </button>
                              </SPAN> 
                                                            <button type="button" class="btn" style="background: #871F1B; color:white;" data-dismiss="modal" onclick="limpiarReporte()">Cerrar</button>
                    ...
                    <div class="x_content">
                     ...
                     <div class="row">
                             ...
                             <SPAN title="Descargar Registros">
                                <button class="btn " style="background: #871F1B; color:white; margin-top:33px" onclick="$('#modal-reporte').modal('show')" ><i class="fa fa-file-excel-o"></i>
                                </button>
                              </SPAN>   
...
<script type="text/javascript" src="../Ajax/DatosAjaxAsistenciaF.js"></script>
