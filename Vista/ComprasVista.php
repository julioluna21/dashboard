            ...
            <form name="formregistros" id="formregistros" method="POST">
				            ...
				            <div class="row">
							  ...
							  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control" name="valor" id="valor" onkeypress="Numero(event)" onkeyup="puntostexto(event)"  required>
                              </div>	
...
<script type="text/javascript" src="../Ajax/ComprasAjax.js"></script>
