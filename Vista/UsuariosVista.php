 ...
 <div id="page-content-wrapper" style="">
		...
		<div class=" shadow p-3  mb-5 bg-white rounded">
		   <SPAN title="Agregar Registro" style="float:right">
              ...
              <button class="btn btn-danger" id="btnagregar" onclick="mostrarform(true)">
		 ...
		 <div class="x_title  ">
            <h1>Usuarios <small>Registro</small></h1>
            ...
            <form name="formregistros" id="formregistros" method="POST">
                            ...
                            <div class="row">
                                ...
                                <input type="password" class="form-control" name="clave" id="clave" min="0"  required="" >
                              </div>   
                                 <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
