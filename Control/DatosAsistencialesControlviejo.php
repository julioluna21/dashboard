...
switch ($_GET["op"]) {
  case 'guardar':
   ...
   case 'Reporte':
        ...
        $arreglo_grua[]=["FECHA SERVICIO","TIPO EVENTO","PR","METROS","UF","TIPO VEHUCULO CONSECIÓN","VEHICULO CONSECIÓN","PR SALIDA","RN SALIDA","PR TRASLADO","RUTA TRASLADO","TIPO VEHICULO ATENDIDO","CATEGORIA","HORA REPORTE","HORA LLEGADA","HORA INICIO TRASLADO","HORA FIN TRASLADO","HORA FIN SERVICIO","HORA BASE"];
        $arreglo_carroTaller[]=["FECHA SERVICIO","TIPO EVENTO","PR","METROS","UF","TIPO VEHUCULO CONSECIÓN","VEHICULO CONSECIÓN","PR SALIDA","RN SALIDA","TIPO VEHICULO ATENDIDO","CATEGORIA","HORA REPORTE","HORA LLEGADA","HORA INICIO TRASLADO","HORA FIN TRASLADO","HORA FIN SERVICIO","HORA BASE"];
        $arreglo_inspectorvial[]=["FECHA SERVICIO","TIPO EVENTO","PR","METROS","UF","TIPO VEHUCULO CONSECIÓN","VEHICULO CONSECIÓN","PR SALIDA","RN SALIDA","TIPO VEHICULO ATENDIDO","CATEGORIA","HORA REPORTE","HORA LLEGADA","HORA INICIO TRASLADO","HORA FIN TRASLADO","HORA FIN SERVICIO","HORA BASE"];
        $arreglo_accidente[]=["FECHA SERVICIO","TIPO EVENTO","PR","METROS","UF","TIPO VEHUCULO CONSECIÓN","VEHICULO CONSECIÓN","PR SALIDA","RN SALIDA","PR TRASLADO","RUTA TRASLADO","TIPO VEHICULO ATENDIDO","CATEGORIA","HORA REPORTE","HORA LLEGADA","HORA INICIO TRASLADO","HORA FIN TRASLADO","HORA FIN SERVICIO","HORA BASE"];
        $arreglo_ambulancia[]=["FECHA SERVICIO","TIPO EVENTO","PR","METROS","UF","TIPO VEHUCULO CONSECIÓN","VEHICULO CONSECIÓN","PR SALIDA","RN SALIDA","PERSONAS ATENDIDAS","HERIDOS GRAVES","HERIDOS LEVES","HERIDOS ILESOS","FALLECIDOS","HORA REPORTE","HORA LLEGADA","HORA INICIO TRASLADO","HORA FIN TRASLADO","HORA FIN SERVICIO","HORA BASE"];

        $rspta = $Consulta->ReporteAsistencialGrua($centro,$fechai,$fechaf);
         while ($reg=$rspta->fetch_object())//mientras exista objeto en la respuesta
         {
          ...
          $rspta = $Consulta->ReporteAsistencialAmbulancia($centro,$fechai,$fechaf);
          while ($reg=$rspta->fetch_object())//mientras exista objeto en la respuesta
          {
            $arreglo_ambulancia[]=[
            $reg->FECHA_SERVICIO,
